...
pkgdatadir = $(datadir)/nwacoin
pkgincludedir = $(includedir)/nwacoin
pkglibdir = $(libdir)/nwacoin
pkglibexecdir = $(libexecdir)/nwacoin
...
ACLOCAL = ${SHELL} /nwacoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /nwacoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /nwacoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /nwacoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = nwacoin-cli
BITCOIN_DAEMON_NAME = nwacoind
BITCOIN_GUI_NAME = nwacoin-qt
BITCOIN_TX_NAME = nwacoin-tx
BITCOIN_WALLET_TOOL_NAME = nwacoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The NWACoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = NWACoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /nwacoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = nwacoin
PACKAGE_BUGREPORT = https://github.com/nwacoin-project/nwacoin/issues
PACKAGE_NAME = NWACoin Core
PACKAGE_STRING = NWACoin Core 0.18.1
PACKAGE_TARNAME = nwacoin
PACKAGE_URL = https://nwacoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /nwacoin
abs_srcdir = /nwacoin
abs_top_builddir = /nwacoin
abs_top_srcdir = /nwacoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /nwacoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/NWACoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/NWACoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NWACoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NWACoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
