...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585889165, 1364585, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2b00c1d37720dc23b763c56ddd390aae77a719aaa9309ba1c442e24e4c3ca0bd"));
        ...
        vSeeds.emplace_back("seed-a.nwacoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.nwacointools.com");
        vSeeds.emplace_back("dnsseed.nwacoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.nwacointools.com");
        vSeeds.emplace_back("seed-b.nwacoin.loshan.co.uk");
