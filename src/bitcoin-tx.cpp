...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nwacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nwacoin-tx [options] <hex-tx> [commands]  Update hex-encoded nwacoin transaction\n" +
            "or:     nwacoin-tx [options] -create [commands]   Create hex-encoded nwacoin transaction\n" +
            "\n";
