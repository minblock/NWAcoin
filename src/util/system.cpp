...
const char * const BITCOIN_CONF_FILENAME = "nwacoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NWACoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NWACoin";
#else
    // Unix
    return pathRet / ".nwacoin";
#endif
#endif
}
