# Support for Output Descriptors in NWACoin Core

Since NWACoin Core v0.17, there is support for Output Descriptors. This is a
...
on NWACoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing NWACoin Core wallets, a convenience function `combo` is
