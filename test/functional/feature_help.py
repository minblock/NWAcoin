...
"""Verify that starting nwacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nwacoin with -h for help text")
        ...
        self.log.info("Start nwacoin with -version for version information")
        ...
        self.log.info("Start nwacoind with -fakearg to make sure it does not start")
